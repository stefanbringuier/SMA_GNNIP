...
def get_min_structure_and_calculate_eos(
    structure,
    potential,
    dbname="EOS.db",
    ...
    eos_eq, v0, e0, B, volumes, energies = calculate_eos(
        opt_structure, potential, strain
    )
    ...
    db.update(
        ...
        fit_eq=eos_eq,
        data={"volumes": volumes, "energies": energies},
    )
