...
\title{Qualitative Assessesment of Graph Neural Network Potentials for  Phonon Properties of Shape Memory Alloys using Graph Neural Network Potentials}
...
\begin{figure}[ht!]
    ...
    \begin{centering}
        ...
        \caption{
          Initial \ce{NiTi} structures (i.e., unrelaxed) used for (a) \textit{B2}(221), (b) \textit{B19}(11), (c) \textit{B19'}(51), and (d) \textit{BCO}(61) with spacegroup numbers are given in the parentheses. The green atoms are \ce{Ni} and \ce{Ti} as gray and unit cells are highlighted with parametes shown on axis. For all unit cells the $\alpha$ and $\gamma$ angles are 90.0$^\circ$. For PtTi, (a-b) structures are used with different unit cell parameters and basis coordinates and then optimized accordingly.
        }
...
%The MACE potential pretrained \texttt{2023-12-03-mace-128-L1_epoch-199.model} checkpoint file.
...
\begin{figure}[ht!]
    ...
    \begin{centering}
        ...
        \caption{
          Comparison of predicted \ce{NiTi} cohesive energy for respective ground-state structure and model. As a reference we use The Materials Project entry for the \ce{NiTi} \textit{B2} entry \cite{MP--571}.
        }
        \label{fig:ecoh_niti}
    \end{centering}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \begin{centering}
        ...
        \caption{
          Comparison of predicted \ce{PtTi} cohesive energy for respective ground-state structure and model.
        }
        \label{fig:ecoh_ptti}
    \end{centering}
\end{figure}
