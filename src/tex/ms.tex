...
\begin{figure}[ht!]
    \script{PlotNiTiCohesiveEnergy.py}
    \begin{centering}
        \includegraphics[width=\linewidth]{figures/NiTi_CohesiveEnergy.png}
        \caption{
...
\begin{figure}[ht!]
    \script{PlotNoStrainPhonons.py}
    \begin{centering}
        \includegraphics[width=\linewidth]{figures/BCO_combined_models_phonon_bandstructures.png}
        \caption{
