...
\begin{figure}[ht!]
    ...
    \begin{centering}
        ...
        \caption{
          Comparison of predicted cohesive energy for respective ground-state structure and model. As a reference we use The Materials Project entry for the \ce{NiTi} \textit{B2} entry \cite{MP--571}.
        }
        \label{fig:ecoh}
    \end{centering}
\end{figure}
